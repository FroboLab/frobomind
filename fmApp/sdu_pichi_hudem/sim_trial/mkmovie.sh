...
DIR_IMAGES="plot_targets" # Location of your images
FILE_VIDEO="my_video.mp4" # Video output file

META_TITLE="Humanitarian Demining Robot"
META_YEAR="2013"
META_COPYRIGHT="Copyright (c) 2013 Kjeld Jensen"
META_COMMENT=""

FRAME_RATE_IN=25 # Change this value to control the frame rate of your time lapse movie
FRAME_RATE_OUT=25
BIT_RATE="500k"
